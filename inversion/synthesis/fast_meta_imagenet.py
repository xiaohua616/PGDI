from inversion.utils.sync_transforms.transforms import Pad, RandomCrop
...
class FastMetaSynthesizerForImageNet(BaseSynthesis):
    ...
    def synthesize(self, targets=None):
        ...
        for it in range(self.iterations):
            ...
            #if it%10==0:
            #    inversion.utils.save_image_batch( inputs, 'checkpoints/vis/%d.png'%(it) )
        ...
        if self.init_dataset is not None:
            init_dst = inversion.utils.UnlabeledImageDataset(self.init_dataset, transform=self.transform)
