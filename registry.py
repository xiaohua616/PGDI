from inversion.models import classifiers, deeplab
from torchvision import datasets, transforms as T
from inversion.utils import sync_transforms as sT
...
from inversion.datasets.smallimagenet import SmallImagenet
...
MODEL_DICT = {
    ...
    'vgg16-half': classifiers.vgg. vgg16_half_bn,
...
def get_dataset(name: str, data_root: str='data', return_transform=False, split=['A', 'B', 'C', 'D']):
    ...
    # if using official downloaded imagenet-32
        ...
        train_dst = inversion.datasets.CUB200(data_root, split='train', transform=train_transform)
        val_dst = inversion.datasets.CUB200(data_root, split='val', transform=val_transform)
        ...
        train_dst = inversion.datasets.StanfordDogs(data_root, split='train', transform=train_transform)
        val_dst = inversion.datasets.StanfordDogs(data_root, split='test', transform=val_transform)
        ...
        train_dst = inversion.datasets.StanfordCars(data_root, split='train', transform=train_transform)
        val_dst = inversion.datasets.StanfordCars(data_root, split='test', transform=val_transform)
        ...
        train_dst = inversion.datasets.TinyImageNet(data_root, split='train', transform=train_transform)
        val_dst = inversion.datasets.TinyImageNet(data_root, split='val', transform=val_transform)
    ...
    # For semantic segmentation
        ...
        train_dst = inversion.datasets.NYUv2(data_root, split='train', transforms=train_transform)
        val_dst = inversion.datasets.NYUv2(data_root, split='test', transforms=val_transform)
    else:
